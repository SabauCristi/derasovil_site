        ...
        <div className="relative flex flex-row items-center justify-center bg-[#F6F9FC] z-0 overflow-hidden shadow-md xl:h-[70vh]">
            <div className="flex flex-row w-[95%] items-start mt-4 md:mt-10 py-8">
                ...
                <div className="flex flex-col justify-end items-end basis-6/12 lg:basis-5/12">
                    <img src={Hero_img} style={{ transform: 'translateX(30%) scale(1.6)' }} className="object-cover object-center rounded-s-full md:aspect-[15/12] aspect-[12/10] lg:hidden"></img>
                    <img src={Hero_img} style={{ transform: 'translateX(25%) scale(1.4)' }} className="object-cover object-center rounded-s-full md:aspect-[15/12] aspect-[12/10] hidden lg:block xl:w-4/5"></img>
                </div>
            </div>
        </div>
    );
