                ...
                <div className="flex flex-col items-center justify-center bg-secondary">
                    ...
                    <div className="grid grid-rows-3 mt-6 gap-3 w-[90%] md:w-[90%] md:gap-6 lg:mt-10 lg:gap-10 mb-6">
                        <div className="flex flex-row items-center gap-3 md:gap-6">
                            <img src={phone_icon} className="aspect-square border-2 border-brick p-3 overflow-visible rounded-full w-[15%] md:p-4 md:w-[10%] lg:p-3 lg:w-[15%] xl:p-3"></img>
                            <p className="text-primary text-2xl text-start pb-1 font-normal md:text-2xl">0773 957 912</p>
                        </div>
                        <div className="flex flex-row items-center gap-3 md:gap-6">
                            <img src={email_icon} className="aspect-square border-2 border-brick p-3 rounded-full overflow-visible w-[15%] md:p-4 md:w-[10%] lg:p-3 lg:w-[15%] xl:p-4"></img>
                            <p className="text-primary text-2xl text-start pb-1 font-normal md:text-2xl">office@derasovil.ro</p>
                        </div>
                        <div className="flex flex-row items-center gap-3 md:gap-6">
                            <img src={location_icon} className="aspect-square border-2 border-brick p-3 rounded-full w-[15%] md:p-4 md:w-[10%] lg:p-3 lg:w-[15%] xl:p-4"></img>
